...
(define (apply-generic-legacy op . args)
...
(get 'exp (list 'scheme-number 'scheme-number))
(get 'exp (list 'complex 'complex))

(apply-generic 'exp (make-scheme-number 2) (make-scheme-number 2))
(apply-generic 'exp (make-complex-from-real-imag 2 0) (make-complex-from-real-imag 2 0))
