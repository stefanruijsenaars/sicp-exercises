    ...
    (let ((proc (get op type-tags)))
      (if proc
          ...
          (if (= (length args) 2)
              ...
              (let* ((arg1 (car args))
                    (arg2 (cadr args))
                    (arg1-raised (raise arg1))
                    (arg2-raised (raise arg2)))
                (cond ((eq? (type-tag arg1) (type-tag arg2-raised)) (apply-generic op arg1 arg2-raised))
                      ((eq? (type-tag arg2) (type-tag arg1-raised)) (apply-generic op arg1-raised arg2))
...
(apply-generic 'add (make-scheme-number 4) (make-rational 4 1))