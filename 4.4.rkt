...
(define (eval-or exp env)
   ...
   (cond ((null? exp) false)
         ...
         ((true? (eval (car exp) env)) (eval (car exp) env))
         ; Otherwise, check the other expressions
...
; 2
(eval '(and true 2) the-global-environment)

; #f
(eval '(or)  the-global-environment)
; 2
(eval '(or 2 true)  the-global-environment)
; #f
(eval '(or false false)  the-global-environment)
; 2
(eval '(or false 2 false)  the-global-environment)
