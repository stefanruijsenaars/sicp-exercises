...
; left to right
(list-of-values     (list 'true 2 3) the-global-environment)

(list-of-values-ltr (list 'true 2 3) the-global-environment)

; this returns (3 2 'true). not sure if this is correct?
(list-of-values-rtl (list 'true 2 3) the-global-environment)
