...
(define poly1 (make-polynomial 'x (adjoin-term (make-term 5 1) (adjoin-term (make-term 0 -1) (the-empty-termlist)))))
(define poly2 (make-polynomial 'x (adjoin-term (make-term 2 1) (adjoin-term (make-term 0 -1) (the-empty-termlist)))))
(display (div poly1 poly2))