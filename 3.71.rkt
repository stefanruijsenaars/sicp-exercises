...
(define cubew (lambda (x) (let ((i (car x))
                                                              (j (cadr x)))
                                                          (+ (* i i i) (* j j j)))))

(define a (weighted-pairs integers integers cubew))
...
(stream-ref rumanujan 0)
(stream-ref rumanujan 1)
(stream-ref rumanujan 2)
(stream-ref rumanujan 3)
(stream-ref rumanujan 4)
(stream-ref rumanujan 5)